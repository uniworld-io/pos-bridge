...
module.exports = async function (deployer) {
    ...
    // const instanceChild = await deployProxy(ChildChainManager, [1, 1, [process.env.MAIN_WALLET_ADDRESS], 98, process.env.MAIN_WALLET_ADDRESS], {
    //     deployer,
    ...
    // //Root chain
    //
    // const instanceRoot = await deployProxy(RootChainManager, [1, 1, [process.env.MAIN_WALLET_ADDRESS], 98, process.env.MAIN_WALLET_ADDRESS], {
    //     deployer,
    //     initializer: 'initialize'
    // });
    // console.log('Deployed RootChainManager: ', instanceRoot.address);
    //
    // const instanceERC20Pre = await deployProxy(ERC20Predicate, [instanceRoot.address], {
    //     deployer,
    //     initializer: 'initialize'
    // });
    // console.log('Deployed instanceErc20Predicate: ', instanceERC20Pre.address);
    //
    // const instanceERC721Pre = await deployProxy(ERC721Predicate, [instanceRoot.address], {
    //     deployer,
    //     initializer: 'initialize'
    // });
    // console.log('Deployed instanceErc721Predicate: ', instanceERC721Pre.address);
    //
    // const instanceERC1155Pre = await deployProxy(ERC721Predicate, [instanceRoot.address], {
    //     deployer,
    //     initializer: 'initialize'
    // });
