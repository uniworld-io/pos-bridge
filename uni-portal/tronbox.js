...
module.exports = {
    networks: {
        mainnet: {
            ...
            /*
              Create a .env.local.local file (it must be gitignored) containing something like
              export PRIVATE_KEY_MAINNET=8da4ef21b864d2cc526dbdb2a120bd2874c36c9d0a1fb7f8c63d7f7a8b41de8f
              Then, run the migration with: source .env.local.local && tronbox migrate --network mainnet
            */
