...
import {CHAIN, WALLET} from "./ConfigEnv";
...
class PoolConnector{
    ...
    constructor() {
        ...
        this.ethChainConnector.eth.accounts.wallet.add(WALLET.PRIVATE_KEY);

        this.bscChainConnector = new Web3(new Web3.providers.HttpProvider(CHAIN.BSC.CHAIN_HOST));
        this.bscChainConnector.eth.accounts.wallet.add(WALLET.PRIVATE_KEY);
